...
from .runtime import replicate_session_log_purge
    ...
    if db_version < 3:
        ...
        for (table_name,) in cursor.fetchall():
            ...
            update_table_columns(
                table_name,
                old=[
                    'event_time', 'type', 'player_name', 'player_id', 'player_team', 'player_role', 'player2_name', 'player2_id',
                    'player2_team', 'player2_role', 'weapon', 'old', 'new', 'team_name', 'squad_name', 'message'
                ],
                new=[
                    'event_time', 'type', 'player_name', 'player_id', 'player_team', 'player_role', 'player_combat_score',
    ...
    if db_version < 7:
        ...
        for (table_name,) in cursor.fetchall():
            ...
            rename_table_columns(
                table_name,
                old=[
                    'event_time', 'type', 'player_name', 'player_steamid', 'player_team', 'player_role', 'player_combat_score',
                    'player_offense_score', 'player_defense_score', 'player_support_score', 'player2_name', 'player2_steamid', 'player2_team',
                    'player2_role', 'weapon', 'old', 'new', 'team_name', 'squad_name', 'message'
                ],
                new=[
                    'event_time', 'event_type', 'player_name', 'player_id', 'player_team', 'player_role', 'player_combat_score',
                    'player_offense_score', 'player_defense_score', 'player_support_score', 'player2_name', 'player2_id', 'player2_team',
                    'player2_role', 'weapon', 'old', 'new', 'team_name', 'squad_name', 'message'
                ]
            )
...
def delete_logs(sess_id: int):
    ...
    database.commit()
    replicate_session_log_purge(int(sess_id))
